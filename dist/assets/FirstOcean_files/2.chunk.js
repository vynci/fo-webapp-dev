...
// module
exports.push([module.i, "tr {\n  font-size: 0.9em; }\n", "", {"version":3,"sources":["/Users/vynci/firstOcean/frontend/SB-Admin-BS4-Angular-4/src/app/layout/reports/reports.component.scss"],"names":[],"mappings":"AAAA;EACI,iBAAiB,EACpB","file":"reports.component.scss","sourcesContent":["tr {\n    font-size : 0.9em;\n}"],"sourceRoot":""}]);
...
var ReportsComponent = (function () {
    ...
    ReportsComponent.prototype.downloadCSV = function () {
        ...
        this._sensorLogService.get(this.globalFilter, 0, 25000)
            ...
            console.log(data);
            _this._jsonToCSVService.Convert(data.data, 'report');
        });
    };
    ReportsComponent.prototype.showGraph = function () {
        var _this = this;
        this.isShowGraph = false;
        this._sensorLogService.get(this.globalFilter, 0, 300)
            .subscribe(function (data) {
            console.log(data);
            ...
            data.data.forEach(function (obj) {
                ...
                _this.lineChartLabels.push(obj.createdDate);
            });
        });
    };
